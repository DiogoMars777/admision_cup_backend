...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tablesOrder = ['rol', 'persona', 'usuario', 'carrera', 'materia', 'aula', 'gestion_cup', 'gestion_academica', 'docente', 'grupo', 'grupo_materia', 'postulante', 'postulante_grupo', 'evaluacion', 'programacion_evaluacion'];
